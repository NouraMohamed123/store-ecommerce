    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">سائل الوصيل</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('shipping_method','inner')}}"
                                   data-i18n="nav.templates.vert.classic_menu">توصيل داخلى</a>
                            </li>
                            <li><a class="menu-item" href="{{route('shipping_method','outer')}}">وصيل خارخى</a>
                            </li>
                            <li><a class="menu-item" href="{{route('shipping_method','free')}}"
                                   data-i18n="nav.templates.vert.compact_menu">توصيل مجانى</a>
                            </li>
